...
knowledge_product_manager = (
    ...
    f"{product_spec}" # Complete this knowledge string by appending the product_spec loaded in TODO 3
)
...
development_engineer_knowledge_agent = KnowledgeAugmentedPromptAgent(openai_api_key = openai_api_key,
...
evaluation_criteria_dev_engineer = (
                        ...
                        "Estimated Effort: Time or complexity estimation\n" 
                        "Dependencies: Any tasks that must be completed first")
development_engineer_evaluation_agent = EvaluationAgent(openai_api_key=openai_api_key,
...
def product_manager_support_function(query):
    # Get a response from the respective Knowledge Augmented Prompt Agent.
    response = product_manager_knowledge_agent.respond(query)
    # Have the response evaluated by the corresponding Evaluation Agent.
...
routes = [
    {"name": "Product Manager",
     "description": "Defines user stories from a product specification",
     "func":product_manager_support_function},
    {"name": "Program Manager",
     "description": "Groups user stories into product features",
     "func": program_manager_support_function},
    {"name": "Development Engineer",
     "description": "defines development tasks from user stories",
...
workflow_steps = action_planning_agent.extract_steps_from_prompt(prompt= workflow_prompt)
...
print(f"##### final output #####: /n {completed_steps[-1]}")